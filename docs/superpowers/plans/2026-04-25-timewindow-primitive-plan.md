...
| 3 | `crates/oneshim-storage/src/sqlite/edge_intelligence/focus_metrics.rs:55` | **B** (verified) — struct literal with row-extracted values (total_active_secs, deep_work_secs, etc. from SQL query) | Production SQL → struct mapping. Use renamed struct literal pattern. |
...
| 5 | `crates/oneshim-storage/src/sqlite/edge_intelligence/focus_metrics.rs:217` | **B** (verified) — struct literal with row-extracted values | Production SQL → struct mapping. Use renamed struct literal pattern. |
...
| 8 | `src-tauri/src/focus_analyzer/mod.rs:384` | **B** (verified) — `total_active_secs: 3600, deep_work_secs: 2400, ...` | Test `focus_score_calculation` |
| 9 | `src-tauri/src/focus_analyzer/mod.rs:420` | **B** (verified) — all-zero custom fields (still struct literal) | Test `focus_score_zero_active_secs` |
| 10 | `src-tauri/src/focus_analyzer/mod.rs:442` | **B** (verified) — `interruption_count: 100, context_switches: 100, ...` | Test `focus_score_max_interruptions_clamped` |
