...
export default function GoalProgressBar({ goals }: GoalProgressBarProps) {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40">
      ...
      <div className="mx-auto max-w-3xl rounded-t-lg border border-b-0 border-content-inverse/10 bg-surface-sunken/80 px-4 py-2 backdrop-blur-md">
        <div className="flex flex-wrap gap-3">
          {goals.map((goal) => (
            <div key={goal.regime_label} className="flex min-w-[180px] flex-1 items-center gap-2">
              ...
              <span className="w-16 text-right text-xs text-content-tertiary">
