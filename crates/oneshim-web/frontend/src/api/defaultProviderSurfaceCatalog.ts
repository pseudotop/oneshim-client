...
export const DEFAULT_PROVIDER_SURFACE_CATALOG: ProviderSurfaceCatalog = {
  ...
  surfaces: [
    ...
    },
    {
      ...
      default_models: { llm_models: ['claude-opus-4-6', 'claude-sonnet-4', 'sonnet', 'opus'], ocr_models: [] },
      parameter_profiles: {
        llm: { supported: [], unsupported: [], notes: [] },
        ocr: { supported: [], unsupported: [], notes: [] },
      },
      subprocess_transport: {
        ...
        auth_probe_command: ['auth', 'status'],
    ...
    {
      surface_id: 'provider_surface.openai.managed_oauth',
      vendor_id: 'openai',
      provider_type: 'OpenAi',
      display_name: 'OpenAI Managed OAuth',
      execution_kind: 'managed_http',
      credential_kind: 'managed_oauth',
      stability: 'experimental',
      preferred_for_product_auth: false,
      catalog_strategy: 'none',
      supports: { llm: true, ocr: false, model_catalog: false, context_bridge: false },
      default_models: { llm_models: ['gpt-5.4', 'gpt-5.2', 'gpt-5-mini'], ocr_models: [] },
      parameter_profiles: {
        llm: { supported: [], unsupported: [], notes: [] },
        ocr: { supported: [], unsupported: [], notes: [] },
      },
    ...
    },
    {
      ...
      subprocess_transport: {
        ...
        auth_probe_command: [],
        invocation_mode: 'gemini_cli_prompt',
        model_flag: '--model',
