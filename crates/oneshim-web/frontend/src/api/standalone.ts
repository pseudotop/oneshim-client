...
function makeDefaultSettings(): AppSettings {
  ...
  return {
    ...
    coaching: { enabled: true, tone: 'Gentle', quiet_hours: [], profiles: { FocusGuard: { enabled: true, min_interval_secs: 300 }, TimeAware: { enabled: true, min_interval_secs: 300 }, DeepWorkCoach: { enabled: true, min_interval_secs: 300 }, ContextRestore: { enabled: true, min_interval_secs: 300 }, GoalTracker: { enabled: true, min_interval_secs: 300 } }, regime_goals: {}, locale: 'en', overlay_mode: 'Minimal' },
