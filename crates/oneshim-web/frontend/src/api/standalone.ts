...
function makeDefaultSettings(): AppSettings {
  ...
  return {
    ...
    audio: { enabled: false, whisper_model_path: '', language: 'auto', max_recording_secs: 60, model_size: 'base', stt_provider: 'local', cloud_api_key: '', cloud_stt_endpoint: 'https://api.openai.com/v1/audio/transcriptions', cloud_timeout_secs: 10 },
  }
}
